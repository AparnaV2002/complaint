...
const EditContact  = () => {
    ...
    const handleSubmit =async (e) =>{
        e.preventDefault();
        const {data}=await axios.post(`http://localhost:8080/edit/${user._id}`,{name,photourl,mobile,email,productname,description,solved})
            ...
            <div className="container">
                <div className="row">
                    <div className="col">
                        ...
                        <p className='fst-italic'>After solving or reading the complaint </p>
                    </div>
                </div>
                {dis && 
                    ...
                    <div className="col-md-4">
                            <form>
                               ...
                               <label className="form-label">Name</label> 
                                ...
                                <div className="mb-2">
                                <label className="form-label">Resolved or not</label> 
